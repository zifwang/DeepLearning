...
'''
COLORCONSTANT = ['r','g','b','y']
# plt.figure()
# for i in range (0,timevarying_coefficents.shape[1]):
#     plt.plot(timevarying_coefficents[:,i], colorString[i], label = 'weight'+str(i))
# plt.legend()
...
#     plt.plot(timevarying_coeff_LMS[:,i], colorString[i], label = 'weight'+str(i))
# plt.legend()
# plt.title('Coefficents')
# plt.xlabel('Update')
# plt.ylabel('Weight')
...
MSE_mismatched_005,weight_mismatched_final_005,weight_tracking_mismatched_005 = lms(mismatched_x,mismatched_y,1,0.05)
MSE_avg_mismatched_005 = averageData(MSE_mismatched_005,mismatched_x.shape[1])
plt.figure()
