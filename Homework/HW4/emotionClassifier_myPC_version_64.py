...
if __name__ == "__main__":
    ...
    model.add(Conv2D(filters=32, kernel_size=(5,5), strides=(1,1), padding='same', data_format='channels_last', activation='relu', input_shape=(height,width,channel), kernel_regularizer=regularizers.l2(0.001)))
